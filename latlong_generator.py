...
def generate_cell_coordinates(cells):
    ...
    with open(csv_path, 'w') as csv_file:
        fieldnames = ['x', 'y', 'bottom_left_lat', 'bottom_left_long',
                      'top_left_lat', 'top_left_long', 'top_right_lat',
                      'top_right_long', 'bottom_right_lat', 'bottom_right_long']
        writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
        writer.writeheader()
        for dict in coordinates:
            writer.writerow({'x': dict['x'], 'y': dict['y'],
                             'bottom_left_lat': dict['bottom_left_lat'],
                             'bottom_left_long': dict['bottom_left_long'],
                             'top_left_lat': dict['top_left_lat'],
                             'top_left_long': dict['top_left_long'],
                             'top_right_lat': dict['top_right_lat'],
                             'top_right_long': dict['top_right_long'],
                             'bottom_right_lat': dict['bottom_right_lat'],
                             'bottom_right_long': dict['bottom_right_long']})
...
def generate_latlongs(amt=10):
    ...
    for cell in cells:
        ...
        while True:
            ...
            distance = [1 for x in distance if x < 1]
